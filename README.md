# edu-learning-hub - 校园智慧学习社区

## 项目简介
edu-learning-hub 是一个前后端分离的校园智慧学习社区，重点覆盖课程管理、课程资源、学习记录、课程评价、学习小组、公共讨论、消息通知和 AI 聊天等典型教学场景。项目将权限体系、动态菜单、业务后台和学习端页面整合在一起，适合做毕业设计展示或课程项目演示。
