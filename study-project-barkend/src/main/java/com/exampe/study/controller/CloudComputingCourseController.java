...
public class CloudComputingCourseController {
    ...
    public RestBean<String> add(@RequestBody CloudComputingCourse cloudComputingCourse) {
    ...
    public RestBean<String> edit(@RequestBody CloudComputingCourse cloudComputingCourse) {
