...
public class CloudComputingStudentLearningRecordController {
    ...
    public RestBean<String> add(@RequestBody CloudComputingStudentLearningRecord cloudComputingStudentLearningRecord,
                                @RequestParam(name = "userId", required = true) String userId, @SessionAttribute("account") AccountUser accountUser) {
        cloudComputingStudentLearningRecord.setUserId(userId);
    ...
    public RestBean<String> edit(@RequestBody CloudComputingStudentLearningRecord cloudComputingStudentLearningRecord, @SessionAttribute("account") AccountUser accountUser) {
        cloudComputingStudentLearningRecord.setUpdateBy(accountUser.getUsername());
        cloudComputingStudentLearningRecord.setUpdateTime(new Date());
